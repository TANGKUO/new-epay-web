...
<body>
	...
	<input type=button onclick="window.open('<%=url %>/epay/query.action','_parent')"  value="查证" style="font: normal 16px arial, sans-serif;padding: 5px 30px 5px 30px;margin : 18px;" />
		<h1>签约2</h1>
		<form action="/newEpay/epay/signSecond.action" method="post">
			<p>请求头</p>
			<table
				...
				<tr>
					...
					<td><input type="text" name="TransId"  value="NUCReq"/></td>
					<td>交易代码</td>
					<td>10</td>
				</tr>
				<tr>
				...
				style="width:670px;background-color: beige; border-width: 2px; margin: auto; padding: 20px;" border="1">
				<tr>
					<td  style="width:37%"><font color="red">*</font>银行账户编号</td>
					<td  style="width:27%"><input type="text" name="BkAcctNo" value="4218700000007422"/></td>
				...
				<tr>
					...
					<td><input type="text" name="PyerAuthMsg" /></td>
					<td></td>
					<td>128</td>
				</tr>
				<tr>
