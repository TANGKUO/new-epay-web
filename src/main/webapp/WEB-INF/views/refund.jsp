...
<body>
	...
	<input type=button onclick="window.open('<%=url %>/epay/query.action','_parent')"  value="查证" style="font: normal 16px arial, sans-serif;padding: 5px 30px 5px 30px;margin : 18px;" />
		<h1>退货</h1>
		<form action="/newEpay/epay/refund.action" method="post">
			<p>请求头</p>
			<table
				...
				<tr>
					...
					<td><input type="text" name="TransId"  value="NSRReq"/></td>
					<td>交易代码</td>
					<td>10</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td  style="width:28%">yyyymmddhhssmmSSSXX</td>
					<td>20</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="RfdTrxAmt" /></td>
					<td>以分为单位</td>
					<td>15</td>
				</tr>
				<tr>
