...
<body>
	...
	<input type=button onclick="window.open('<%=url %>/epay/query.action','_parent')"  value="查证" style="font: normal 16px arial, sans-serif;padding: 5px 30px 5px 30px;margin : 18px;" />
		<h1>解约</h1>
		<form action="/newEpay/epay/signCancel.action" method="post">
			<p>请求头</p>
			<table
				...
				<tr>
					...
					<td><input type="text" name="TransId"  value="NCSReq"/></td>
					<td>交易代码</td>
					<td>10</td>
				</tr>
				<tr>
				...
				style="width:670px;background-color: beige; border-width: 2px; margin: auto; padding: 20px;" border="1">
				<tr>
					<td  style="width:37%"><font color="red">*</font>交易时间</td>
					<td  style="width:27%"><input type="text" name="TrxDtTm"  value="<%=s.format(time)%>"/></td>
					<td  style="width:28%">yyyy-MM-dd'T'HH:mm:ss</td>
					<td>19</td>
				</tr>
				<tr>
					<td><font color="red">*</font>签约协议号</td>
					<td><input type="text" name="SgnNo"/></td>
					<td>4218700000007422</td>
					<td>34</td>
				</tr>
				<tr>
