...
<div align="center">
	...
	<input type=button onclick="window.open('<%=url %>/old/query.action','_parent')"  value="老查证" style="font: normal 16px arial, sans-serif;padding: 5px 30px 5px 30px;margin : 18px;" />	<h2>老签约结果</h2>
	<c:if test="${result['Flag'] eq '1'}">
		<c:choose>
			...
			<table style="width:670px;background-color: #93FF93; border-width: 2px; margin: auto; padding: 20px;" border="1">
				...
				<tr>
					<td><font color="red">*</font>银行卡号</td>
					<td>${result['cardNo']}</td>
					<td></td>
					<td>22</td>
				</tr>
