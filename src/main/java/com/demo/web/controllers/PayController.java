...
import com.demo.web.bean.NQPReq;
...
public class PayController {
    ...
    public ModelAndView query(HttpServletRequest request,Model model,NQPReq NQPReq,String url){
		String xml=NQPReq.toString();
		log.info("订单查询原数据："+xml);
		String signXml=signatureTest.sign(xml, "NQPReq");
